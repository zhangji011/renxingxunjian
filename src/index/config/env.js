...
if (debug == 1) { //生产
    ...
    baseUrl.api = 'https://find.cmpay.com:9102/RHXJServer/';
    ...
    // baseUrl.api = 'http://113.108.79.80:3020/RHXJServer/'; //综测本地---
    baseUrl.api = 'https://hbtest.letshappy.cn/RHXJServer/'; //综测服务器----
