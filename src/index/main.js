...
Vue.use(Viewer);
Viewer.setDefaults({
  Options: { "inline": false, "button": true, "navbar": false, "title": true, "toolbar": false, "tooltip": true, "movable": false, "zoomable": true, "rotatable": false, "scalable": true, "transition": true, "fullscreen": true, "keyboard": true, "url": "data-source" }
});
import "./config/rem";
