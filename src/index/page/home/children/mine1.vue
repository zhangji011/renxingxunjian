    ...
    <section class="s_1">
      <ul>
        ...
        <span class="icon"><img src="/static/img/1-20.png"></span>
          ...
          <span v-show="searchT!=''"  @click = "clear()" class="clearspan">
            <img src="/static/img/Group6.png" class="clearimg">
          </span>
        </li>
...
export default {
  ...
  methods: {
    ...
    loadMore() {
      ...
      this.CURRENTPAGE += 1;
       axios.post("merchants/queryXjInfoByName", {
